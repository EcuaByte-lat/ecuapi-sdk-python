...
class Invoice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "organizationId", "status", "type", "subtotal", "taxAmount", "totalAmount", "accessKey", "recipientName", "recipientId", "recipientPhone", "createdAt", "updatedAt"]
