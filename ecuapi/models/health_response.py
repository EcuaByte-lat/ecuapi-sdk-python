...
class HealthResponse(BaseModel):
    ...
    checks: Optional[HealthResponseChecks] = None
    timestamp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "name", "version", "environment", "docs", "checks", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "docs": obj.get("docs"),
            "checks": HealthResponseChecks.from_dict(obj["checks"]) if obj.get("checks") is not None else None,
