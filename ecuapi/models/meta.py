...
class Meta(BaseModel):
    ...
    per_page: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="perPage")
    total: Optional[Union[StrictFloat, StrictInt]] = None
    total_pages: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPages")
    __properties: ClassVar[List[str]] = ["requestId", "timestamp", "page", "perPage", "total", "totalPages"]
