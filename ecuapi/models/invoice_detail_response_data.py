...
class InvoiceDetailResponseData(BaseModel):
    """
    ...
    recipient_phone: StrictStr = Field(alias="recipientPhone")
    created_at: StrictStr = Field(alias="createdAt")
    updated_at: StrictStr = Field(alias="updatedAt")
    items: List[Any]
    __properties: ClassVar[List[str]] = ["id", "organizationId", "status", "type", "subtotal", "taxAmount", "totalAmount", "accessKey", "recipientName", "recipientId", "recipientPhone", "createdAt", "updatedAt", "items"]
