...
class AuthorizeInvoiceResponse(BaseModel):
    """
    AuthorizeInvoiceResponse
    """ # noqa: E501
    data: AuthorizeInvoiceResponseData
    meta: Meta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AuthorizeInvoiceResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
