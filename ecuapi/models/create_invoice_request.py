...
class CreateInvoiceRequest(BaseModel):
    ...
    """ # noqa: E501
    customer: Customer
    items: Annotated[List[InvoiceItem], Field(min_length=1, max_length=500)]
    payment_method: Optional[StrictStr] = Field(default='01', description="01 = Sin sistema financiero", alias="paymentMethod")
    notes: Optional[Annotated[str, Field(strict=True, max_length=500)]] = None
    __properties: ClassVar[List[str]] = ["customer", "items", "paymentMethod", "notes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentMethod": obj.get("paymentMethod") if obj.get("paymentMethod") is not None else '01',
            "notes": obj.get("notes")
        })
        return _obj
