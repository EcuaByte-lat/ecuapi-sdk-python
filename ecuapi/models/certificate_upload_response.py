...
class CertificateUploadResponse(BaseModel):
    ...
    """ # noqa: E501
    data: CertificateUploadResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CertificateUploadResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": CertificateUploadResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
