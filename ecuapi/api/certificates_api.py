...
class CertificatesApi:
    ...
    def upload_certificate(
        self,
        password: StrictStr,
        file: Annotated[Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]], Field(description="P12 certificate file")] = None,
        ...
        :type password: str
        :param file: P12 certificate file
        :type file: bytearray
        :param alias:
        :type alias: str
        :param _request_timeout: timeout setting for this request. If one
